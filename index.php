...
<div id="leftSide">
    <div id="logo">
        <h1>
            <a href="index.php">
                <img src="images/heart2x.png" alt="logo" />
            </a>
        </h1>
    </div>
	<ul>
...
<li id="page_about">
    ...
    <p style="text-align:justify;">
			DIY is Love is a company which promotes the love for "Do It Yourself Customization products" which were on trends nowadays. The company got a variety of products which the customers were likely to order.
			Also, one of the features of the company is that you can also upload your own design to be submitted and could be ordered by other customers. In that way, you can also make money while you were on your own house by presenting to us your own design.
			DIY is LOVE is your one-stop shop to DIY products. Come and help us recreate the world by recycling useful joys to ourselves.
		</p>
...
<li id="page_gallery">
    ...
    <ul class="splitter" id="filter">
        ...
        <ul>
            ...
            <li class="segment-0"><a href="#" data-value="non_veg">Earrings</a></li>
            <li class="segment-2"><a href="#" data-value="veg">Bracelets</a></li>
            <li class="segment-3"><a href="#" data-value="drinks">Coin Purse</a></li>
			<li class="segment-4"><a href="#" data-value="tshirt">Valentine Gifts</a></li>
        </ul>
        </li>
    </ul>
    </div>
    <div class="image_grid">
        <ul id="list" class="portfolio_list">
            <li data-id="id-1" class="non_veg">
                    ...
                    <img src="images/e6.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-1" class="non_veg">
                
                    <span class="roll"></span>
                    <img src="images/e8.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-1" class="non_veg">
                
                    <span class="roll"></span>
                    <img src="images/e15.jpg" alt="img" class="img_bor" />
           
            </li>
            
            <li data-id="id-4" class="veg">
                    <span class="roll"></span>
                    <img src="images/b3.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-4" class="veg">
                    <span class="roll"></span>
                    <img src="images/b4.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-4" class="veg">
                    <span class="roll"></span>
                    <img src="images/13.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-4" class="veg">
                    <span class="roll"></span>
                    <img src="images/29.jpg" alt="img" class="img_bor" />
            </li>
			
            <li data-id="id-7" class="drinks">
                    <span class="roll"></span>
                    <img src="images/7.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-7" class="drinks">
                    <span class="roll"></span>
			...
			<li data-id="id-7" class="drinks">
                    <span class="roll"></span>
                    <img src="images/23.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-7" class="drinks">
                    <span class="roll"></span>
                    <img src="images/27.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-7" class="drinks">
                    <span class="roll"></span>
                    <img src="images/28.jpg" alt="img" class="img_bor" />
            </li>
			
			<li data-id="id-1" class="tshirt"><span class="roll"></span>

                    <img src="images/12.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-1" class="tshirt"><span class="roll"></span>
                    <img src="images/2.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-1" class="tshirt"><span class="roll"></span>
                    <img src="images/19.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-1" class="tshirt"><span class="roll"></span>
                    <img src="images/20.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-1" class="tshirt"><span class="roll"></span>
                    <img src="images/22.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-1" class="tshirt"><span class="roll"></span>
                    <img src="images/666.jpg" alt="img" class="img_bor" />
            </li>
