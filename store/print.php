...
<img src="../images/heart2x.png" width="100" height="100" style="float:left;"><strong>DIY is LOVE Online Ordering System</strong><br>Kabankalan City<br>Email Us: happydreamz16@gmail.com<br>Contact: <a href="#">(+63927)7440549</a>
<br><br><br><br>
<?php
include('connect.php');
		$id=$_GET['id'];
		...
		while($row = mysql_fetch_array($result))
			{
				...
				echo 'note: if the Delivery Type is Outside Kabankalan It has an 500 delivery charge ';
